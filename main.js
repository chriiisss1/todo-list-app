const formAddTasks = document.querySelector(".form-add-tasks");
const InputAddTasks = document.querySelector(".input-add-tasks");
const buttonAddTasks = document.querySelector(".icon-add-tasks");
