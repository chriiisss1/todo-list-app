...
const renderTasks = (tasks) => {
  ...
  const tasksHTML = tasks
    .map((task) => {
      ...
      <div class="task">
        <div class="left-side">
          <svg class="task-circle-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
            <path
        ...
        <svg class="task-trash-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
          <path
  ...
  const markedTasksHTML = markedTasks
    .map((markedTasks) => {
      ...
      <div class="marked-task">
        <div class="left-side">
          <svg class="marked-task-circle-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
            <path
        ...
        <svg class="marked-task-trash-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
          <path
            d="M256-213.847 213.847-256l224-224-224-224L256-746.153l224 224 224-224L746.153-704l-224 224 224 224L704-213.847l-224-224-224 224Z" />
        </svg>
      </div>`;
